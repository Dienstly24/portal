...
<div class="sidebar" id="admin-sidebar">
    ...
    <div class="nav-group" data-group="vertrieb">
        ...
        <div class="nav-group-body">
            ...
            {{-- Interne Provisionen: Provisionsdaten aus Fremdsystemen am
                 Vertrag. Der Punkt erscheint nur fuer Berechtigte - der
                 Zugriff selbst haengt am Gate, nicht an dieser Sichtbarkeit. --}}
            @can('provisionen-verwalten')
            <a href="{{ route('admin.commissions_internal.index') }}" class="nav-item {{ request()->routeIs('admin.commissions_internal.*') ? 'active' : '' }}">
