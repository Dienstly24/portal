...
.wb-gold { background:#F3EDDC; color:#8A7440; border:1px solid var(--gold-soft); }
...
.pv-bar > span { display:block; height:100%; background:linear-gradient(90deg,var(--emerald-bright),var(--emerald-deep)); border-radius:999px; }
.pv-bar-gold > span { background:linear-gradient(90deg,var(--gold-soft),var(--gold)); }
</style>
