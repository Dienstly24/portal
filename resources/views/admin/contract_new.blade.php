...
<div class="card" style="max-width:980px;">
    ...
    <div class="field">
        ...
        <div id="selected-display" style="display:none;margin-top:8px;padding:10px 14px;background:var(--emerald-soft);border-radius:8px;font-size:13px;font-weight:600;color:var(--emerald);">
