    ...
    <form method="POST" action="{{ route('admin.banners.social.save', $banner->id) }}">
            ...
            <div class="field">
                ...
                <div style="display:flex;gap:16px;flex-wrap:wrap;margin-top:8px;">
                    ...
                    <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13.5px;">
                        ...
                        <input type="checkbox" name="platforms[]" value="{{ $key }}" style="width:16px;height:16px;padding:0;margin:0;appearance:auto;-webkit-appearance:checkbox;background:none;border:none;border-radius:0;accent-color:var(--emerald);"
        ...
        <div style="border:1px dashed var(--line);border-radius:10px;padding:12px 14px;margin-bottom:14px;">
            <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13.5px;font-weight:600;">
                <input type="checkbox" name="auto_publish" value="1" style="width:16px;height:16px;padding:0;margin:0;appearance:auto;-webkit-appearance:checkbox;background:none;border:none;border-radius:0;accent-color:var(--emerald);"
            ...
            <div id="scheduledWrap" style="display:{{ old('auto_publish', $post?->scheduled_for) ? 'flex' : 'none' }};gap:10px;align-items:center;margin-top:10px;flex-wrap:wrap;">
                ...
                <span class="muted-xs">Der Planer prüft alle 15 Minuten. TikTok bleibt manuell (TikTok öffnet seine API nur nach App-Audit).</span>
            </div>
        ...
        <div style="display:flex;gap:14px;align-items:center;flex-wrap:wrap;">
            ...
            <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13.5px;">
                <input type="checkbox" name="create_task" value="1" style="width:16px;height:16px;padding:0;margin:0;appearance:auto;-webkit-appearance:checkbox;background:none;border:none;border-radius:0;accent-color:var(--emerald);">
...
<div class="card">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:16px;">
        ...
        <div style="border:1px solid var(--line);border-radius:12px;padding:12px;">
            ...
            <div style="background:var(--graphite);border-radius:8px;display:flex;align-items:center;justify-content:center;padding:6px;">
...
<div class="card">
    ...
    <div class="scroll-x">
    <table>
        <thead><tr><th>Plattform</th><th>Tracking-Link (in den Beitrag)</th><th class="num">Klicks</th><th>Letzter Klick</th><th>Veröffentlicht</th><th></th></tr></thead>
        <tbody>
        ...
        <tr>
            ...
            <td style="font-size:12.5px;">
                ...
                @endif
                @if($ch->publisher)<span class="muted"> von {{ $ch->publisher->name }}</span>
                @elseif($ch->external_post_id)<span class="muted"> automatisch</span>@endif
