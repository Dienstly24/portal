...
<div class="card">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="font-size:12.5px;">
                ...
                @if($ch->publisher)<span style="color:var(--ink-soft);"> von {{ $ch->publisher->name }}</span>@endif
                @else
    ...
    <div style="margin-top:14px;border-top:1px dashed var(--line);padding-top:12px;font-size:12.5px;color:var(--ink-soft);line-height:1.7;">
        ...
        📘 <strong>Facebook:</strong> Bild „Feed-Post" oder „Link-Vorschau" + Text + Tracking-Link direkt im Beitrag.<br>
