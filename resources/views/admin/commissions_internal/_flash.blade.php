...
@if(session('success'))
<div style="background:var(--emerald-soft);border:1px solid #9BD9BB;border-radius:10px;padding:14px 16px;margin-bottom:20px;max-width:1200px;font-size:13px;">{{ session('success') }}</div>
@endif
@if(session('error'))
