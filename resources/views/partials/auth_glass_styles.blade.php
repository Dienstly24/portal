...
.card h2{font-size:20px;color:var(--gold-soft);margin-bottom:16px;}
label{display:block;font-size:13px;margin-bottom:6px;color:#dde0e5;}
.field{position:relative;margin-bottom:16px;}
.field input{width:100%;background:rgba(0,0,0,.25);border:1px solid var(--glass-line);border-radius:10px;color:#fff;font-size:14.5px;padding:12px 13px;outline:none;transition:border-color .2s;}
.field input:focus{border-color:var(--emerald);}
.btn{width:100%;background:linear-gradient(180deg,var(--emerald-bright),var(--emerald-deep));border:1px solid #1fc06e;color:#fff;font-size:15.5px;font-weight:700;padding:13px;border-radius:11px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;transition:transform .15s, box-shadow .2s, filter .2s;}
...
.back-line a{color:var(--emerald-mint);font-weight:700;text-decoration:none;}
