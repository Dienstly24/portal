...
<style>
.d24c-av{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,var(--emerald-bright),var(--emerald-deep));color:#fff;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:12.5px;flex:none;letter-spacing:.02em;}
...
.d24c-bub.me{background:var(--gold-soft,var(--emerald-soft));align-self:flex-end;border-start-end-radius:4px;}
.d24c-sender{font-size:11.5px;font-weight:700;color:var(--emerald-deep);display:inline-flex;align-items:center;gap:6px;flex-wrap:wrap;}
...
.d24c-ticks.read{color:var(--emerald-deep);}
...
.d24c-chip:hover{border-color:var(--emerald);color:var(--emerald-deep);}
...
.d24c-inp:focus{outline:2px solid var(--emerald);outline-offset:1px;background:#fff;}
.d24c-send{width:42px;height:42px;border-radius:50%;border:none;background:linear-gradient(135deg,var(--emerald-bright),var(--emerald-deep));color:#fff;font-size:16px;cursor:pointer;flex:none;box-shadow:0 4px 12px rgba(18,138,75,.35);display:flex;align-items:center;justify-content:center;}
...
.kx-card-link{font-size:11.5px;color:var(--emerald-deep);text-decoration:none;font-weight:600;}
.kx-internal{background:#FBF6E4;border-color:#E7D9A8;align-self:flex-end;max-width:76%;}
.kx-tag{font-size:10.5px;font-weight:700;color:var(--emerald-deep);text-decoration:none;background:rgba(18,138,75,.08);border-radius:6px;padding:1px 7px;align-self:flex-start;}
</style>
