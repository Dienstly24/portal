...
h2{font-size:17px;margin:22px 0 8px;color:#1a3c34;}
p,li{font-size:14.5px;line-height:1.7;color:#333;}
ul{padding-left:22px;margin:6px 0;}
.card{background:#fff;border:1px solid #E4E0D4;border-radius:12px;padding:26px 28px;}
.muted{color:#6B7280;font-size:13px;margin-top:14px;}
.custom{white-space:pre-line;}
a{color:#185FA5;}
.foot{background:#fff;border-top:1px solid #E4E0D4;padding:16px 22px;}
