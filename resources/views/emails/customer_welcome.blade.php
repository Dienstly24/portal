...
{{-- E-Mail-HTML: tabellenbasiert, Inline-Styles, absolute URLs, KEIN SVG
     ...
     Markenfarben: Petrol #17191d, Grün #17A65B, Blau #185FA5. --}}
...
<tr><td align="center" style="padding:14px 30px 4px;">
    <a href="{{ $magicLoginUrl }}" style="display:inline-block;background:#17A65B;color:#ffffff;font-size:16px;font-weight:bold;text-decoration:none;padding:13px 36px;border-radius:10px;">➜ &nbsp;Jetzt automatisch anmelden</a>
...
<tr><td style="padding:13px 18px;">
    <p style="font-size:12px;color:#17191d;margin:0 0 8px;letter-spacing:.06em;"><strong>IHRE ZUGANGSDATEN</strong></p>
...
<tr><td style="padding:14px 30px 2px;">
    <p style="font-size:12px;color:#17191d;margin:0 0 10px;letter-spacing:.06em;text-align:center;"><strong>✨ WAS KÖNNEN SIE IM PORTAL TUN?</strong></p>
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="50%" style="padding:0 5px 10px 0;">
                <a href="{{ $portalBase }}/contracts" style="text-decoration:none;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fb;border:1px solid #dfe3e8;border-radius:12px;"><tr>
                    ...
                    <td style="padding:16px 12px 16px 6px;"><span style="font-size:15px;color:#17191d;font-weight:bold;">Verträge</span><br><span style="font-size:12px;color:#777;">alle auf einen Blick</span></td>
                </tr></table></a>
            </td>
            <td width="50%" style="padding:0 0 10px 5px;">
                <a href="{{ $portalBase }}/documents" style="text-decoration:none;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fb;border:1px solid #dfe3e8;border-radius:12px;"><tr>
                    <td width="52" align="center" style="font-size:26px;padding:16px 4px 16px 14px;">📁</td>
                    <td style="padding:16px 12px 16px 6px;"><span style="font-size:15px;color:#17191d;font-weight:bold;">Dokumente</span><br><span style="font-size:12px;color:#777;">sicher abrufen</span></td>
                </tr></table></a>
            </td>
        </tr>
        <tr>
            <td width="50%" style="padding:0 5px 0 0;">
                <a href="{{ $portalBase }}/tickets/create" style="text-decoration:none;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fb;border:1px solid #dfe3e8;border-radius:12px;"><tr>
                    <td width="52" align="center" style="font-size:26px;padding:16px 4px 16px 14px;">💬</td>
                    <td style="padding:16px 12px 16px 6px;"><span style="font-size:15px;color:#17191d;font-weight:bold;">Support</span><br><span style="font-size:12px;color:#777;">Anfrage stellen</span></td>
                </tr></table></a>
            </td>
            <td width="50%" style="padding:0 0 0 5px;">
                <a href="{{ $portalBase }}/profile" style="text-decoration:none;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f9fb;border:1px solid #dfe3e8;border-radius:12px;"><tr>
                    <td width="52" align="center" style="font-size:26px;padding:16px 4px 16px 14px;">👤</td>
                    <td style="padding:16px 12px 16px 6px;"><span style="font-size:15px;color:#17191d;font-weight:bold;">Meine Daten</span><br><span style="font-size:12px;color:#777;">aktuell halten</span></td>
                </tr></table></a>
            </td>
        </tr>
    </table>
