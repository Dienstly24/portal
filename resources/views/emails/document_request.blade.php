...
<p style="font-size:16px;font-weight:bold;color:#1e3a8a;margin:0 0 6px;">{{ $documentRequest->title }}</p>
...
<p style="text-align:center;margin:25px 0;"><a href="{{ route('portal.documents') }}" style="background:#1e3a8a;color:#ffffff;padding:12px 30px;border-radius:8px;text-decoration:none;font-size:15px;">Dokument jetzt hochladen</a></p>
