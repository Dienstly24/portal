...
.hint{font-size:11.5px;color:#a7bfb5;margin-top:3px;}
...
.login-line{text-align:center;font-size:13px;color:#b8cec5;margin-top:clamp(6px,1.4vh,14px);}
...
.consent{display:flex;gap:9px;align-items:flex-start;font-size:12.5px;color:#a7bfb5;margin:2px 0 clamp(6px,1.4vh,10px);}
