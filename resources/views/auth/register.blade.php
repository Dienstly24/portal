...
.field input{width:100%;background:rgba(0,0,0,.25);border:1px solid var(--glass-line);border-radius:10px;color:#fff;font-size:14.5px;padding:clamp(9px,1.7vh,12px) 13px;outline:none;transition:border-color .2s;}
...
.consent input{margin-top:2px;width:15px;height:15px;accent-color:var(--emerald);}
