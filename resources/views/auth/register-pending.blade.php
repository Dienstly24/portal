...
<style>
:root{--green:#17A65B;--mint:#3ddc8e;--line:rgba(255,255,255,.14);--gold-line:rgba(184,161,107,.4);}
...
.card h2{font-size:24px;color:var(--mint);margin-bottom:10px;}
...
.steps li{color:#dde0e5;font-size:14px;line-height:1.6;padding:9px 0 9px 30px;position:relative;border-bottom:1px solid var(--line);}
.steps li:last-child{border-bottom:none;}
.steps li::before{content:'✓';position:absolute;{{ $rtl ? 'right' : 'left' }}:0;color:var(--green);font-weight:700;}
