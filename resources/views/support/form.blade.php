...
.card{background:rgba(255,255,255,.06);border:1px solid var(--glass-line);border-radius:18px;padding:clamp(18px,2.6vh,30px);max-width:520px;width:100%;backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);box-shadow:0 24px 60px rgba(0,0,0,.35);}
.card h1{font-size:22px;color:var(--emerald-mint);margin:0 0 6px;line-height:1.25;font-weight:700;}
...
.field input,.field select,.field textarea{width:100%;background:rgba(0,0,0,.25);border:1px solid var(--glass-line);border-radius:10px;color:#fff;font-size:14.5px;padding:11px 13px;outline:none;transition:border-color .2s;font-family:inherit;}
.field select option{background:var(--graphite-deep);color:#fff;}
...
.btn{width:100%;background:linear-gradient(180deg,var(--emerald-bright),var(--emerald-deep));border:1px solid #1fc06e;color:#fff;font-size:16px;font-weight:700;padding:14px;border-radius:11px;cursor:pointer;margin-top:6px;transition:transform .15s, box-shadow .2s, filter .2s;}
