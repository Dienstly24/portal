...
.lang-switch a{display:inline-flex;align-items:center;gap:7px;background:rgba(255,255,255,.08);border:1px solid var(--line);color:#dfe9e4;text-decoration:none;font-size:13px;padding:7px 13px;border-radius:9px;}
...
.card .lead{color:#b8cec5;font-size:13.5px;line-height:1.5;margin-bottom:clamp(10px,2vh,18px);}
...
.field select option{background:#142e27;color:#fff;}
.field input:focus,.field select:focus,.field textarea:focus{border-color:var(--green);}
.field input[readonly]{opacity:.75;cursor:default;}
.kd{display:flex;gap:10px;align-items:center;background:rgba(45,156,110,.12);border:1px solid rgba(45,156,110,.4);border-radius:10px;padding:10px 14px;margin-bottom:14px;font-size:13.5px;color:#c9e6d8;}
...
.foot{display:flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:6px 18px;padding:clamp(8px,1.6vh,14px) 16px;font-size:12.5px;color:#a7bfb5;}
