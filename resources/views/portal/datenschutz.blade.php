...
<div class="card">
    ...
    <ul style="font-size:14px;color:var(--ink);line-height:1.8;padding-left:20px;margin:0;">
        <li>{!! __('Die Verarbeitung erfolgt <strong>ausschließlich zur Betreuung Ihrer Verträge</strong>.') !!}</li>
        <li>{!! __('Sensible Daten (z. B. Bankverbindung) werden <strong>verschlüsselt</strong> gespeichert.') !!}</li>
        <li>{!! __('Ihre Daten geben wir <strong>nicht unbefugt an Dritte</strong> weiter.') !!}</li>
