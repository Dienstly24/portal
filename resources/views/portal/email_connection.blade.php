...
@if($consent)
    ...
    <div class="card">
        ...
        <div style="background:var(--surface,var(--graphite-deep));color:#fff;border-radius:10px;padding:14px 16px;font-family:monospace;font-size:15px;word-break:break-all;margin:12px 0;">
            {{ $importAddress }}
        </div>
