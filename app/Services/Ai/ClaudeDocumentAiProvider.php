...
class ClaudeDocumentAiProvider implements DocumentAiProviderInterface
{
    ...
    private function systemPrompt(): string
    {
        ...
        return 'Du analysierst Dokumente (Scans, Fotos, PDFs) fuer einen deutschen Versicherungs- und Energie-Makler. '
            ...
            .'und den Anschrift-Aufkleber (person.street/house_number/zip/city). Auf dem Aufkleber stehen PLZ und Ort oft ZUERST '
            .'und die Strasse mit Hausnummer darunter. Die Anschrift der ausstellenden BEHOERDE (neben "AUSSTELLUNGSDATUM-BEHOERDE") '
            .'ist NIE die Anschrift der Person. '
