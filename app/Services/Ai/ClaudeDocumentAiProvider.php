...
class ClaudeDocumentAiProvider implements DocumentAiProviderInterface
{
    ...
    private function systemPrompt(): string
    {
        ...
        return 'Du analysierst Dokumente (Scans, Fotos, PDFs) fuer einen deutschen Versicherungs- und Energie-Makler. '
            ...
            . '"energie": {"meter_number": "", "malo_id": "<11 Ziffern>", "meter_reading": <Zahl Zaehlerstand>, "meter_register": <einer aus: 1.8.0, 1.8.1, 1.8.2, 2.8.0>, "meter_unit": <kWh|m³>, "consumption_kwh": <Zahl Jahresverbrauch>, "tariff": "", "customer_number": "<Kundennummer beim bisherigen Versorger>"}, '
